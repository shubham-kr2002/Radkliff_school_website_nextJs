          ...
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-16 relative z-10">
            ...
            <div className="w-full lg:w-1/2 flex justify-center relative order-2 lg:order-1">
              <div className="relative w-full max-w-[500px] aspect-square rounded-[3rem] p-4 md:p-6 group">
                ...
                <div className="relative w-full h-full flex items-center justify-center overflow-hidden rounded-[2.5rem]">
                  <Image src="/about-image-2.png" alt="About Radkliffe" fill className="object-cover group-hover:scale-105 transition-transform duration-1000" />
                </div>
                {/* Magical Washi Tape */}
            ...
            <div className="w-full lg:w-1/2 flex flex-col text-center lg:text-left order-1 lg:order-2">
              ...
              <p className="font-body-lg text-base md:text-xl text-on-surface-variant/90 mb-8 leading-relaxed max-w-2xl mx-auto lg:mx-0">
                Nestled in the heart of our community, Radkliffe is a premium sanctuary for early childhood development. We believe that every child is a unique universe of potential waiting to be discovered.
              </p>
          ...
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 lg:gap-20 relative z-10">
            ...
            <div className="w-full md:w-1/2 order-2 md:order-1 text-center md:text-left space-y-6">
              ...
              <div className="space-y-1">
                ...
                <p className="font-label-sm text-sm uppercase tracking-wider text-on-surface-variant font-semibold">Principal, Radkliffe</p>
              </div>

              <div className="h-1 w-16 bg-primary/30 mx-auto md:mx-0 rounded-full"></div>

              <p className="font-body-lg text-lg text-on-surface-variant leading-relaxed">
                Leading with <span className="font-bold text-primary">25+ years of educational experience</span>, she brings a wealth of knowledge, deep compassion, and visionary leadership to Radkliffe. 
              </p>
